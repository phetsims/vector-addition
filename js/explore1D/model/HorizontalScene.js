...
/**
 * Model for the vertical scene on the Explore1D scene. This scene only has one vectorSet.
 *
 * @author Brandon Li
 */
define( require => {
  ...
  class HorizontalScene extends Scene {
    ...
    constructor( 
      ...
      this.graph.orientation = VectorOrientations.VERTICAL;
    ...
    createVectorSets( componentStyleProperty ) {
      // Create the vector set vector set
  ...
  return vectorAddition.register( 'HorizontalScene', HorizontalScene );
} );
