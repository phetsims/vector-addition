...
define( require => {
  ...
  class VectorLabelNode extends Node {
    ...
    constructor( rootVector, modelViewTransformProperty, valuesVisibleProperty, activeVectorProperty, options ) {
      ...
      super();
      //----------------------------------------------------------------------------------------
      const label = new VectorLabel( null, null, null, rootVector.vectorColorGroup, activeVectorProperty.value === RootVector );
      this.addChild( label );
      ...
      this.updateLabelNode = ( valuesVisible ) => {
        ...
        label.setCoefficient( labelDisplayData.coefficient );
        label.setValue( labelDisplayData.value );
        label.setSymbol( labelDisplayData.symbol );
      };
