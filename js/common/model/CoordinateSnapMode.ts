...
export default class CoordinateSnapMode extends EnumerationValue {

  // Vector tail and tip are snapped to an exact grid coordinate (components are always integers).
  public static readonly CARTESIAN = new CoordinateSnapMode();
  ...
  public static readonly POLAR = new CoordinateSnapMode();

  public static readonly enumeration = new Enumeration( CoordinateSnapMode );
}

vectorAddition.register( 'CoordinateSnapMode', CoordinateSnapMode );