...
//TODO https://github.com/phetsims/vector-addition/issues/258 Identical to Explore2DVectorToolboxSlot, except ICON_VECTOR_COMPONENTS
/**
 * Explore2DVectorToolboxSlot is a slot in the vector toolbox for the 'Explore 2D' screen.
...
const ICON_VECTOR_COMPONENTS = new Vector2( 1, 1 );

export default class Explore2DVectorToolboxSlot extends InteractiveHighlighting( HBox ) {
  ...
  public constructor( vector: Vector,
    ...
    const iconViewComponents = modelViewTransform.viewToModelDelta( ICON_VECTOR_COMPONENTS );
...
vectorAddition.register( 'Explore2DVectorToolboxSlot', Explore2DVectorToolboxSlot );