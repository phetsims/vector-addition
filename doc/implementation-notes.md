...
* _graph orientation_ to 1-dimensional grams, and is horizontal or vertical, see [GraphOrientations](https://github.com/phetsims/vector-addition/blob/master/js/common/model/GraphOrientations.js)
